...
export function DistanceProfitScatterChart({ loadBreakdown }: DistanceProfitScatterChartProps) {
    ...
    <ChartContainer config={chartConfig} className="h-64 w-full">
      ...
      >
        ...
        <YAxis
          ...
          label={{ value: 'Net Profit ($)', angle: -90, position: 'insideLeft', className: 'text-xs' }}
        />
        <ZAxis
          type="number"
          dataKey="payout"
              ...
              formatter={(value, name, props) => {
                if (props.payload) {
                  return [
                    ...
                    name === 'profit' ? 'Net Profit' : name === 'distance' ? 'Distance' : 'Payout',
                  ]
                }
                return [value, name]
              }}
